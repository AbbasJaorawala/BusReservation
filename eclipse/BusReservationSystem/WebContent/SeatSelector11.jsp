...
<div class="inputForm">
<center>
<form method="post" action="noOfSeat" onSubmit="return validate()">
  Number of Seats *: <input type="number" name="numberOfSeats"id="Numseats" required>
  <br/><br/>
...
<script src='https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js'></script><script  src="./selectSeat11.js"></script>
